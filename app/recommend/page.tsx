...
const products: Record<string, { id: number; name: string; price: string; rating: string; emoji: string; tags: string[]; url: string }[]> = {
  ...
  'タブレット': [
    { id: 1, name: 'iPad Air M2', price: '¥98,800', rating: '4.8', emoji: '📲', tags: ['Apple', '軽量', 'M2チップ'], url: 'https://www.amazon.co.jp/s?k=iPad%20Air%20M2&tag=amanavi05-22' },
    { id: 2, name: 'iPad mini 7', price: '¥78,800', rating: '4.7', emoji: '📲', tags: ['Apple', 'コンパクト', '持ち運び'], url: 'https://www.amazon.co.jp/s?k=iPad%20mini%207&tag=amanavi05-22' },
    { id: 3, name: 'Galaxy Tab S9', price: '¥89,800', rating: '4.6', emoji: '📲', tags: ['Android', 'AMOLED', 'Samsung'], url: 'https://www.amazon.co.jp/s?k=Galaxy%20Tab%20S9&tag=amanavi05-22' },
    { id: 4, name: 'Fire HD 10', price: '¥19,980', rating: '4.3', emoji: '📲', tags: ['コスパ', 'Amazon', '動画'], url: 'https://www.amazon.co.jp/s?k=Fire%20HD%2010&tag=amanavi05-22' },
  ...
  'モニター': [
    ...
    { id: 2, name: 'ASUS ROG Swift', price: '¥89,800', rating: '4.7', emoji: '🖥', tags: ['ゲーミング', '144Hz', 'ASUS'], url: 'https://www.amazon.co.jp/s?k=ASUS%20ROG%20Swift&tag=amanavi05-22' },
    { id: 3, name: 'Dell U2722D', price: '¥54,800', rating: '4.7', emoji: '🖥', tags: ['仕事', 'USB-C', 'Dell'], url: 'https://www.amazon.co.jp/s?k=Dell%20U2722D&tag=amanavi05-22' },
    { id: 4, name: 'BenQ EW2880U', price: '¥44,800', rating: '4.5', emoji: '🖥', tags: ['4K', 'HDR', 'コスパ'], url: 'https://www.amazon.co.jp/s?k=BenQ%20EW2880U&tag=amanavi05-22' },
    { id: 5, name: 'Samsung 49インチ曲面', price: '¥98,000', rating: '4.6', emoji: '🖥', tags: ['ウルトラワイド', '曲面', 'Samsung'], url: 'https://www.amazon.co.jp/s?k=Samsung%2049%E3%82%A4%E3%83%B3%E3%83%81%E6%9B%B2%E9%9D%A2&tag=amanavi05-22' },
  ],
  'PC周辺機器': [
    { id: 1, name: 'HHKB Professional', price: '¥35,200', rating: '4.7', emoji: '⌨️', tags: ['キーボード', '高級', '打鍵感'], url: 'https://www.amazon.co.jp/s?k=HHKB%20Professional&tag=amanavi05-22' },
    { id: 2, name: 'ロジクール MX Master 3', price: '¥14,800', rating: '4.8', emoji: '🖱', tags: ['マウス', '仕事', 'ロジクール'], url: 'https://www.amazon.co.jp/s?k=%E3%83%AD%E3%82%B8%E3%82%AF%E3%83%BC%E3%83%AB%20MX%20Master%203&tag=amanavi05-22' },
    { id: 3, name: 'Anker 65W充電器', price: '¥3,990', rating: '4.7', emoji: '🔌', tags: ['充電', 'コンパクト', 'USB-C'], url: 'https://www.amazon.co.jp/s?k=Anker%2065W%E5%85%85%E9%9B%BB%E5%99%A8&tag=amanavi05-22' },
    { id: 4, name: 'ロジクール C920n', price: '¥9,800', rating: '4.6', emoji: '📷', tags: ['Webカメラ', 'テレワーク', 'フルHD'], url: 'https://www.amazon.co.jp/s?k=%E3%83%AD%E3%82%B8%E3%82%AF%E3%83%BC%E3%83%AB%20C920n&tag=amanavi05-22' },
    { id: 5, name: 'Twelve South HiRise', price: '¥8,800', rating: '4.5', emoji: '💻', tags: ['スタンド', 'Mac', 'デスク整理'], url: 'https://www.amazon.co.jp/s?k=Twelve%20South%20HiRise&tag=amanavi05-22' },
  ],
  'Nintendo Switch': [
